  ...
  return (
    <div style={{ background: 'white', borderRadius: 12, padding: '24px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)', marginTop: 28 }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20 }}>
        <h3 style={{ color: '#1a3a6b', margin: 0, fontWeight: 700 }}>Recent Activities</h3>
        <span style={{ color: '#1a3a6b', fontSize: 14, cursor: 'pointer', fontWeight: 500 }}>View All</span>
      </div>
          ...
          {activities.map((a, i) => (
            <tr key={i} style={{ borderBottom: '1px solid #f0f4f8' }}>
              <td style={{ padding: '16px', fontSize: 14, color: '#555' }}>
                <span style={{ marginRight: 8 }}>🕐</span>{a.time}
              </td>
